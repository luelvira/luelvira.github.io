...
#+EXPORT_FILE_NAME: tutorial_haskell_build_a_simple_calc_simple_calculator
#+title: Tutorial Haskell - Build a simple calc simple calculator
#+date: <2024-07-11 Thu>
...
#+cite_export: 
#+filetags: :PERMANENT:TUTORIAL:PUBLISH:
* Simple calculator
...
:PROPERTIES:
:ID:       a17fc509-05d8-44e7-9cc2-cc556d0b3878
:END:
#+hugo_auto_set_lastmod: t#+hugo_base_dir: ../../#+hugo_bundle: default#+DATE: [2024-08-27 Tue 16:54]
