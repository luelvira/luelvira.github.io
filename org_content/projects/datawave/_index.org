...
:EXPORT_HUGO_BUNDLE: datawave/datawave_page
:END:
...
#+ATTR_HTML: :class gap-7
#+begin_cols-8
#+ATTR_HTML: :class flex-align__center
#+begin_col-1-4
#+ATTR_HTML: :alt Use case: Viewing the result of the process
[[file:results_graph_crop.png]]
#+end_col-1-4
#+ATTR_HTML: :class flex-align__center
#+begin_col-4-auto
#+ATTR_HTML: :alt Use case: Editing the results provided by the model
[[file:results_graph_edit-edited.png]]
#+end_col-4-auto
#+end_cols-8
...
#+ATTR_HTML: :alt Use case: Use the web interface :class w-1/2 m-auto
[[file:process_1.png]]
